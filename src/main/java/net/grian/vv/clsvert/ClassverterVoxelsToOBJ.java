...
public class ClassverterVoxelsToOBJ implements Classverter<VoxelArray, OBJModel> {
    ...
    public OBJModel invoke(VoxelArray array, Object... args) {
        ...
        Arguments.requireAllNonnull(args);
    ...
    private static void addMaterials(TempVoxel[] voxels, OBJModel model) {
        MTLLibrary mtllib = new MTLLibrary("voxel_materials");
